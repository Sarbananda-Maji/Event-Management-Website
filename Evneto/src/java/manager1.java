...
public class manager1 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)throws IOException, ServletException
    {
        ...
        try
        {
            ...
            String q1 = "select * from manager where status2='false'";
            ...
            {
                pw1.println("<tr><td>"+x.getString(1)+"</td><td>"+x.getString(4)+"</td><td>"+x.getString(5)+"</td><td>"+x.getString(8)+"</td><td><a href=mreq?id="+x.getString(2)+">Send Request</a></td></tr>");
            }
